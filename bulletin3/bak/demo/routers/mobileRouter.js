...
define(
		[ "jquery", "backbone", "demo/models/CategoryModel",
				"demo/collections/CategoriesCollection", "demo/views/CategoryView" ],
		function($, Backbone, CategoryModel, CategoriesCollection, CategoryView) {
			...
			var CategoryRouter = Backbone.Router.extend({
				...
				// Backbone.js Routes
				routes : {
					// When there is no hash bang on the url, the home method is
					// called
					"" : "home",
					// When #category? is on the url, the category method is
					// called
				...
				// Category method that passes in the type that is appended to
				// the url hash
				category : function(type) {
					// Stores the current Category View inside of the
					...
					if (!currentView.collection.length) {
						...
						$.mobile.loading("show");
						// Fetches the Collection of Category Models for the
						// current Category View
						currentView.collection.fetch().done(function() {
							// Programatically changes to the current categories
							// page
